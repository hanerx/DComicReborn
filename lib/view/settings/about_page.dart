...
class _AboutPageState extends State<AboutPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(S.of(context).AboutSettings)),
      body: Center(
            ...
            children: [
              ...
              _buildPanel(context, [
                ListTile(
                  ...
                  title: Text(
                    S.of(context).AboutPageCheckForUpdate,
                ...
                ListTile(
                  leading: Icon(
                    FontAwesome5.git_alt,
                    color: colorScheme.primary,
                  ),
                  title: Text(
                    S.of(context).AboutPageUpdateChannel,
                    style: Theme.of(context).textTheme.bodyLarge
                        ?.copyWith(color: colorScheme.onSurface),
                  ),
                  subtitle: Text(
                ...
                ListTile(
                  ...
                  title: Text(
                    S.of(context).SettingPageShowReleaseInfo,
                    style: Theme.of(context).textTheme.bodyLarge
                        ?.copyWith(color: colorScheme.onSurface),
                  ),
                  subtitle: Text(
              ...
              _buildPanel(context, [
                ...
                ListTile(
                  ...
                  title: Text(
                    S.of(context).AboutPageAbout,
                    style: Theme.of(context).textTheme.bodyLarge
                        ?.copyWith(color: colorScheme.onSurface),
                  ),
                  subtitle: Text(
                    S.of(context).AboutPageAboutSubtitle,
                    style: TextStyle(color: colorScheme.onSurfaceVariant),
                  ),
                  onTap: () {
                    showAboutDialog(
