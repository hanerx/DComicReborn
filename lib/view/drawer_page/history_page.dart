    ...
    try {
      ...
      if (context.mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              isChinese ? '历史记录加载失败，请检查网络和对应漫画源的登录状态后重试' : 'Could not load history. Check your connection and source login, then retry.',
            ),
          ),
        );
      }
          ...
          appBar: AppBar(
            ...
            actions: [
              IconButton(
                ...
                icon: Icon(
                  _iconMap[Provider.of<ComicHistoryPageController>(context)
                      .sourceType],
                ),
              ),
            ],
