...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m12(status) => "${Intl.select(status, {
            ...
            'signedIn': '今日已签到',
            'notSignedIn': '今日未签到',
            'queryFailed': '查询失败，请刷新重试',
            'signInFailed': '签到未成功，请刷新确认',
            'other': '签到状态未知'
          })}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "ComicViewerPageChapterComments": MessageLookupByLibrary.simpleMessage(
          "本章吐槽",
        ),
        ...
        "ComicViewerPageNoComments":
            MessageLookupByLibrary.simpleMessage("本章暂无吐槽"),
        "ComicViewerPageShowMore": MessageLookupByLibrary.simpleMessage("显示更多"),
        ...
        "CopyMangaRoutingHint": MessageLookupByLibrary.simpleMessage(
          "上方选择热辣即可使用热辣图片配合拷贝章节吐槽。两站账号独立，切换立即生效，保留本地收藏与阅读记录。",
        ),
        ...
        "DebugPageShowSplashTitle":
            MessageLookupByLibrary.simpleMessage("显示开屏页"),
        ...
        "HotMangaTitle": MessageLookupByLibrary.simpleMessage("热辣漫画"),
        ...
        "ZaiManHuaAutoSignIn": MessageLookupByLibrary.simpleMessage("自动签到"),
        "ZaiManHuaAutoSignInHint": MessageLookupByLibrary.simpleMessage(
          "每日签到及 VIP 福利",
        ),
        ...
        "ZaiManHuaVipDailyReward":
            MessageLookupByLibrary.simpleMessage("VIP 每日福利"),
